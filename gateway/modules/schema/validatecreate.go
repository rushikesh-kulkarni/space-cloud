...
func (s *Schema) SchemaValidator(col string, collectionFields model.SchemaFields, doc map[string]interface{}) (map[string]interface{}, error) {
...
func (s *Schema) checkType(col string, value interface{}, fieldValue *model.SchemaFieldType) (interface{}, error) {
