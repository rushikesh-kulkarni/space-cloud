...
func (s *Schema) Inspector(ctx context.Context, dbType, project, col string) (model.SchemaCollection, error) {
...
func generateInspection(dbType, col string, fields []utils.FieldType, foreignkeys []utils.ForeignKeysType, indexes []utils.IndexType) (model.SchemaCollection, error) {
	inspectionCollection := model.SchemaCollection{}
	inspectionFields := model.SchemaFields{}

	for _, field := range fields {
		fieldDetails := model.SchemaFieldType{FieldName: field.FieldName}
...
func inspectionMySQLCheckFieldType(typeName string, fieldDetails *model.SchemaFieldType) error {
...
func inspectionPostgresCheckFieldType(typeName string, fieldDetails *model.SchemaFieldType) error {
