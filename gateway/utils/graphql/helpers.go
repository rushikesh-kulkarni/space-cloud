...
func (graph *Module) processLinkedResult(ctx context.Context, field *ast.Field, fieldStruct model.SchemaFieldType, token string, req *model.ReadRequest, store utils.M, loader *loaderMap, cb callback) {
...
func (graph *Module) processQueryResult(ctx context.Context, field *ast.Field, token string, store utils.M, result interface{}, loader *loaderMap, schema model.SchemaFields, cb callback) {
