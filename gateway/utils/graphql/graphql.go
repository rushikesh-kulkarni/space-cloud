...
func (graph *Module) execGraphQLDocument(ctx context.Context, node ast.Node, token string, store utils.M, loader *loaderMap, schema model.SchemaFields, cb callback) {
	switch node.GetKind() {
